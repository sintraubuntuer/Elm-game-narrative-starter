            ...
            case msg of
                ...
                NewCoordsForInterId interactableId mbGpsZone needsToBeInZone interactionExtraInfo (Ok location) ->
                    let
                        ...
                        --  _ = Debug.log "debug distances" distanceToAllLocs
                        inDistance =
                                ...
                                Just strUrl ->
                                    let
                                        ...
                                        newInteractionExtraInfoTwo =
                                            { newInteractionExtraInfo
                                                | mbInputText = Nothing
                                                , bkAnsStatus = EngineTypes.WaitingForInfoRequested
                                            }
                                    in
                                        ( { newModel
                                        ...
                                        , getBackendAnswerInfo interactableId newInteractionExtraInfo thestrUrl
                                        )
                    else
                ...
                LoadHistory obj ->
                    let
                        ...
                        --_ = Debug.log "list of history interactions to be loaded is : " newlist
                        savedSettings =
                            model.settingsModel
...
getBackendAnswerInfo interactableId interactionExtraInfo strUrl =
    ...
    in
        Http.send (AnswerChecked interactableId interactionExtraInfo) request
